...
export default function GetAllPokemons(props: Record<string, any>) {

  const { count, pokemons } = props;
  ...
  const handleChangeSearch = (event: any) => {
    ...
    dispatch(getPaginatedPokemons(page, 1302, event.target.value))
  }
          ...
          <TableBody>
            {pokemons.map((pokemon: any) => (
              ...
              >
                ...
                <TableCell>
                  <AddPokemon pokemon={pokemon.name}/>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
